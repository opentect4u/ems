...
class CompOffs extends MX_Controller {
    ...
    public function f_add(){
        ...
        if($_SERVER['REQUEST_METHOD'] == "POST"){
            ...
            $transCd = $this->Leave->f_get_particulars("td_comp_apply", array("max(trans_cd) + 1 trans_cd"), NULL, 1);
            ...
            $data_array     =   array (
                ...
                "recommend_remarks"=> ($this->session->userdata('loggedin')->emp_type == 'H')? 'HOD' : NULL,

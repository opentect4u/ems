                    ...
                    <table id="demo-foo-addrow" class="table m-t-30 table-hover contact-list" data-page-size="10">
                        ...
                        <tbody id="intro"> 
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select class="form-control preferenceSelect" name="managed_emp[]" style="width: 275px;">
                                            ...
                                            <?php foreach ($emp_dtls as $list):?>
                                                ...
                                                <option value="<?php echo $list->emp_code;?>"
                                                    ...
                                                    <?php echo ($list->emp_code == $manage_by->managed_emp)? 'selected' : '';?>
                            ...
                            <?php
                                    ...
                                    echo "<tr id='void'><td colspan='10' style='text-align: center;'>No data Found</td></tr>";
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#addrow").click(function(){
            ...
            $("#intro").prepend('<tr><td><select class="form-control preferenceSelect" name="managed_emp[]" style="width: 275px;"><option>Select</option><?php foreach ($emp_dtls as $list):?><option value="<?php echo $list->emp_code;?>"><?php echo $list->emp_name;?></option><?php endforeach;?> </select></td><td><a href="javascript:void(0)" id="removeRow" title="Remove Employee" style="margin-left: 30px; color: #2f3d4a;"><i class="mdi mdi-table-row-remove" aria-hidden="true"></i></a></td></tr>');
